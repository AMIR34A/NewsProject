...
if (isset($_POST['sabt']))
{
    ...
    $date = $_POST['date'];
    $query = "INSERT INTO `news` (`title`,`matn`,`date`,`catid`,`pic`,`user`,`status`) VALUES ('$title','$matn','$date','$catid','$image','$islogin','pending')";
            ...
            <table border="1" align="center" style="margin: 20px auto">
                ...
                while ($row = mysqli_fetch_assoc($res)){
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="approve.php?id=<?php echo $row['id']; ?>&status=approved" class="fa fa-check" title="تأیید" style="color:green;margin:5px;"></a>
                            <a href="approve.php?id=<?php echo $row['id']; ?>&status=rejected" class="fa fa-times" title="رد" style="color:red;"></a>
                        </td>
                    </tr>
                <?php } ?>
                </tbody>
